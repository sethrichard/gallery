...
$sql = "SELECT * FROM requests WHERE accept = 1"; //You don't need a ; like you do in SQL
$result = mysql_query($sql) or exit ("SQLquerry error".mysql_error());

echo '<p>This table shows pending requests. View <a href = "acceptedrequests.php"> Accepted </a> or <a href ="rejectedrequests.php"> Rejected</a> requests</p>';
...
<td><a href='acceptrequest.php?request_id=" . $row['request_id'] . "'>Accept</a> or <a href='requestreject.php?request_id=" . $row['request_id'] . "'>Reject</a></td>
